...
$pass	       		= $_POST['password'];
$hak	       		= $_POST['hak_akses'];
$query = mysqli_query($conn,"UPDATE pegawai SET nama='$nama',jk='$jk', ttl='$ttl', golongan='$gol', jabatan='$jb', pd='$pd', username='$user', password='$pass', hak_akses='$hak' WHERE nip='$nip'");
if ($query){
