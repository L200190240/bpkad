                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                      ...
                                      <?php
                                     $tampil=mysqli_query($conn, "SELECT uploadst.nosurat, uploadst.nip, pegawai.nama, uploadst.nama_file from uploadst, pegawai where pegawai.nip=uploadst.nip");
